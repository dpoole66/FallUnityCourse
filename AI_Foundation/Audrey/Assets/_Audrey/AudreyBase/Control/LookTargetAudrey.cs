...
namespace RealisticEyeMovements {
	...
	public class LookTargetAudrey : MonoBehaviour
	{
		#region fields
		...
		Transform ChooseNextHeadTargetPOI()
		{
			...
			{
				if  ( pointsOfInterest[i] != null && pointsOfInterest[i] != targetPOI && eyeAndHeadAnimator.CanGetIntoView(pointsOfInterest[i].position) )
					numPOIsInView++;
			}
			if ( numPOIsInView == 0 )
				return targetPOI;
		...
		public void Initialize()
		{
			...
			//*** Player eyes: either user main camera or VR cameras
			{
				...
				{
					if ( Camera.main == null && thirdPersonPlayerEyeCenter == null)
					{
					...
					else
					{
						...
						Transform playerXform = Camera.main.transform;
			...
			UpdateThirdPersonPlayerEyeCenter();
		...
		{
			if ( false == useVR )
				playerEyeCenterXform = (thirdPersonPlayerEyeCenter != null) ? thirdPersonPlayerEyeCenter : Camera.main.transform;
		}
		...
		void UpdateThirdPersonPlayerEyeCenter()
		{
			if ( thirdPersonPlayerEyeCenter == usedThirdPersonPlayerEyeCenter )
				return;
			...
			if ( thirdPersonPlayerEyeCenter != null )
			{
				...
				playerEyeCenterXform = thirdPersonPlayerEyeCenter;
				playerLeftEyeXform = thirdPersonPlayerEyeCenter;
				playerRightEyeXform = thirdPersonPlayerEyeCenter;
			}
			else if ( useNativeVRSupport )
			{
				playerEyeCenterXform = createdPlayerEyeCenterGO.transform;
